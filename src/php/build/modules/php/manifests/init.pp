class php {
  ...
  file { '/usr/local/src/phpfarm/src/custom/options-5.6.10.sh':
    ...
    source => 'puppet:///modules/php/usr/local/src/phpfarm/src/custom/options-5.6.10.sh',
    mode => 755,
  ...
  file { '/usr/local/src/phpfarm/inst/php-5.6.10/etc/php-fpm.conf':
    ...
    source => 'puppet:///modules/php/usr/local/src/phpfarm/inst/php-5.6.10/etc/php-fpm.conf',
    mode => 644,
    require => Bash_exec['/usr/local/src/phpfarm/src/main.sh 5.6.10']
  }
