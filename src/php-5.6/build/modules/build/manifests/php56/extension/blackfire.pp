class build::php56::extension::blackfire {
  require build::php56

  bash_exec { 'mkdir -p /var/run/blackfire': }

  file { '/usr/local/src/phpfarm/inst/php-5.6.10/lib/php/extensions/no-debug-non-zts-20131226/blackfire-php-linux_amd64-php-56.so':
    ensure => present,
